az functionapp config appsettings set -n wandle-function-v2 -g wandle-function-v2-rg --settings \
...
az functionapp restart -n wandle-function-v2 -g wandle-function-v2-rg
